# Refer to https://github.com/dmlc/dgl/blob/master/examples/pytorch/graphsage/train_full.py
import torch
import torch.nn as nn
import torch.nn.functional as F
# from dgl.nn.pytorch.conv import SAGEConv

# SAGEConv copied from https://docs.dgl.ai/_modules/dgl/nn/pytorch/conv/sageconv.html#SAGEConv
import torch.nn as nn
...
class GraphSAGE(nn.Module):
    ...
    The "K" - number of aggregators in GraphSAGE paper should be equivalent to n_layers here?
    """
    ...
    def forward(self, graph, inputs):
        ...
        for l, layer in enumerate(self.layers):
            h = layer(graph, h, edge_weight=graph.edata['weight'])
            # h = layer(graph, h)
